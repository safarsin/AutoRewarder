...
- Don't use the Edge window/profile controlled by AutoRewarder while it is running (it can interfere with automation)
...
Using this app may lead to account restrictions or suspension. AutoRewarder uses randomized delays and varied interactions, but nothing can guarantee safety.
