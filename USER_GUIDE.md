...
- **Provider & model:** Choose OpenAI, OpenRouter, Anthropic, or Google Gemini, and optionally a specific model (leave blank to use a sensible default for that provider).
